...
function PrincipalColetor({ navigation, route }:NativeStackScreenProps<any,any>){
    useEffect(() =>{
        setTimeout(() => {alert("Bem vindo?:" + JSON.stringify(route.params))}, 1000);
    }, []);
    let coletor = route.params?.valores.coletor;
    return (
        <View style={styles.container}>
            ...
            <animatable.View animation="fadeInUp" style={styles.containerForm}>
                ...
                <animatable.View animation="fadeInUp" delay={500} style={styles.containerButtonAction}>
                    <TouchableOpacity style={styles.buttonAction} onPress={() => {navigation.navigate('Alterar',{coletor:coletor})}}>
...
export default PrincipalColetor;