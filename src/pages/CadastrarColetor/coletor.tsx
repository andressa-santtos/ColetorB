...
export default function CadastrarColetor() {
    ...
    const [foto_coletor, setFotoColetor] = useState('');
    ...
    const uploadImage = async (e: { preventDefault: () => void; }) => {
        ...
        formData.append('foto_coletor', foto_coletor);
        ...
        await axios.post("/UPimage", formData, headers)
        .then((response)=>{
            setStatus({
                type: 'sucess',
            ...
            <animatable.View animation="fadeInUp" style={styles.containerForm}>
                <ScrollView style={styles.form}>
                    <View style={styles.imgContainer}>
                        <Image style={styles.image} source={foto_coletor ? { uri: foto_coletor } : require('../../assets/icons/img/addUser.png')} />
                        <Header fetchImages={uploadImage} />
                    </View>
